...
public class AdminPanel extends javax.swing.JFrame {
  ...
  private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    int selectedRowId = Integer.parseInt(adminBooked.getValueAt(selectedRow, 0).toString().substring(2));
  ...
  private void initComponents() {
    ...
    searchLabel1.setText("Search by email or Phone Number :");
  ...
  private void searchFieldActionPerformed(java.awt.event.ActionEvent evt) { // GEN-FIRST:event_searchFieldActionPerformed
    if (searchField.getText().isEmpty()) {
      ...
      populateSystemEmailsTable(searchField.getText());
    }
  ...
  private void searchFieldBookedActionPerformed(
    ...
    if (searchFieldBooked.getText().isEmpty()) {
      ...
      populateAdminBookedTable(searchFieldBooked.getText());
    }
